...
export default function Profile(){
 ...
 return(
  ...
  className="m-2 sm:text-7xl text-white text-4xl font-bold"
/>
   ...
   <a target="_blank" href="https://www.linkedin.com/in/lokkuchakreshkumar/"><button className="p-4 text-white bg-black border border-white rounded-lg hover:border hover:border-black hover:text-black hover:bg-white hover:cursor-pointer flex justify-center items-center"><AiOutlineSend className="inline mr-2"/>Let's Connect</button></a>
