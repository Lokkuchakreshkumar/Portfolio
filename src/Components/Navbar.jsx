...
export default function Navbar(){
    ...
    return (
        <div className="w-[90%]  md:w-2/3  rounded-3xl text-white bg-white/10 backdrop-blur-2xl h-16 fixed top-3 left-1/2 translate -translate-x-1/2 flex items-center z-10"> 
